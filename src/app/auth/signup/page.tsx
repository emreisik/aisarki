    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-[400px]">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-white/20 rounded-full py-3 text-white font-semibold hover:border-white/50 transition-colors mb-6"
        >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Kullanıcı adı (örn: dj_emre)"
              value={username}
              onChange={(e) =>
                setUsername(
